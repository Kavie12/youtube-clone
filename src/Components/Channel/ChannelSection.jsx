...
const ChannelSection = () => {
    ...
    return (
        <ContentEnvironment>
            <div className="mt-14">
                <img src="/Banners/banner1.jpg" alt="banner" className="w-[1060px] h-[170px] max-[600px]:h-[100px] object-cover rounded-xl" />
                <div className="flex items-stretch gap-x-8 mt-2">
                    ...
                    <div className="flex flex-col items-start justify-center gap-y-4">
                        ...
                        <button className="bg-transparent border-none bg-yt-white text-yt-black py-2 px-4 font-Roboto text-sm rounded-2xl font-medium">Subscribe</button>
                    </div>
                </div>
