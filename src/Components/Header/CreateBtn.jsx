...
const CreateDropdown = props => {
    return (
        <div className={`absolute top-12 left-0 z-10 bg-yt-gray py-2 rounded-lg ${!(props.display) ? 'hidden' : ''}`}>
...
const CreateBtn = () => {
    ...
    return (
        <div className='relative'>
            <div className='cursor-pointer hover:bg-yt-white/15 rounded-full p-3' onMouseOver={() => setHoverState(1)} onMouseOut={() => setHoverState(0)} onClick={() => { menuState ? setMenuState(0) : setMenuState(1) }}>
